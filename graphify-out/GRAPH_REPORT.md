...
## Corpus Check
- 116 files · ~92,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 735 nodes · 1744 edges · 54 communities (47 shown, 7 thin omitted)
...
4. `checkPastDueByProject()` - 28 edges
5. `Button()` - 25 edges
6. `checkIfProjectArchived()` - 24 edges
7. `getRequestOrigin()` - 22 edges
8. `sendEmail()` - 16 edges
9. `compilerOptions` - 16 edges
10. `Faberdoc - Registro de Sesiones (Sessions Log)` - 16 edges
...
- `SidebarProjectItem()` --calls--> `cn()`  [EXTRACTED]
  src/components/layout/sidebar.tsx → src/lib/utils.ts
...
Cohesion: 0.16
Nodes (23): Step, CustomPropertyDef, FlowCondition, FlowConfigManager(), CreateProjectDialogContent(), CreateProjectDialogContentProps, EmptyProjectsViewProps, CreateTransmittalDialogProps (+15 more)
...
Cohesion: 0.15
Nodes (24): cn(), Command(), CommandDialog(), CommandEmpty(), CommandGroup(), CommandInput(), CommandItem(), CommandList() (+16 more)
...
Cohesion: 0.06
Nodes (52): DocumentCreateDialog(), DocumentCreateDialogProps, DocumentImportDialog(), DocumentImportDialogProps, DocumentTable(), DocumentTableProps, ProjectRole, DocumentToolbar() (+44 more)

### Community 6 - "Authentication & Password Management Pages"
Cohesion: 0.10
Nodes (13): ForgotPasswordPageProps, loginAction(), resetPasswordAction(), verifyOtpAction(), LoginPageProps, RegisterPageProps, RegisterFormClient(), ResetPasswordPage() (+5 more)
...
Cohesion: 0.15
Nodes (12): STATUS_OPTIONS, DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuSeparator() (+4 more)

### Community 10 - "Organization Settings & Admin Storage Actions"
Cohesion: 0.07
Nodes (36): DashboardLayout(), Sidebar(), SidebarProps, getUserInitials(), UserNav(), UserNavProps, getInviteEmailHtml(), ProjectWithRole (+28 more)
...
Cohesion: 0.22
Nodes (9): ALL_ROLES, OrgMemberRow, ProjectMemberRow, ProjectRole, ProjectTeamPanelProps, ROLE_BADGE_CLASSES, ROLE_LABELS, Badge() (+1 more)

### Community 13 - "Maestro de Documentos (MDL) Table Views"
Cohesion: 0.39
Nodes (6): generateDocumentColumns(), IssueStatus, RevisionStatus, STATUS_CONFIG, StatusBadge(), StatusBadgeProps

### Community 14 - "Review Flow Templates & Email Notifications"
Cohesion: 0.36
Nodes (5): RevisionTimeline(), RevisionTimelineProps, DocumentIssue, FileRecord, Revision

### Community 15 - "Transmittals UI & Emisiones Tables"
Cohesion: 0.15
Nodes (9): mockDocumentRows, mockOrganizations, mockProjects, mockProjectsWithRole, mockTransmittalRows, mockUsers, IssuanceLog, Organization (+1 more)
...
Cohesion: 0.16
Nodes (3): LocalStorageService, R2StorageService, StorageService

### Community 18 - "Onboarding and User Access Requests Flow"
Cohesion: 0.25
Nodes (7): Document, PaymentStatus, ProjectMember, Subscription, SubscriptionExpense, SubscriptionStatus, Transmittal

### Community 19 - "Resend SMTP Email Integration & Signup Actions"
Cohesion: 0.06
Nodes (91): GET(), GET(), ReviewFlow, GET(), sendEmail(), BaseEmailOptions, getBaseEmailLayout(), getClientConnectionEmailHtml() (+83 more)
...
Cohesion: 0.24
Nodes (10): DeletedDocument, DeletedProject, ProjectTeamPanel(), CustomPropertyDef, SettingsTabsClientProps, Tabs(), TabsContent(), TabsList() (+2 more)
...
Cohesion: 0.12
Nodes (15): DocumentDrawer(), DocumentDrawerProps, ProjectRole, PROPERTY_ICONS, PROPERTY_LABELS, DocumentDetail, SystemComment, createClient() (+7 more)
...
Cohesion: 0.24
Nodes (7): IssuesClient(), IssuesClientProps, IssueViewModel, IssuesPage(), IssuesPageProps, ProjectMemberRole, getIssuesPageDataAction()
...
- **Why does `cn()` connect `Revision Control & Access Verification` to `Document Management Dialogs & Forms`, `Dashboard Layout & Navigation Shell`, `Common UI Components & Utilities`, `Authentication & Password Management Pages`, `User Profile Settings & Nav Dropdown`, `Organization Settings & Admin Storage Actions`, `Client Connection Management Actions`, `Document Drawer & Comment System Panels`, `Community 54`, `Shadcn/ui Sheet & Lateral Slider Layout`, `Skeleton Loaders & Loading Components`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `createClient()` connect `Resend SMTP Email Integration & Signup Actions` to `Common UI Components & Utilities`, `Authentication & Password Management Pages`, `Organization Settings & Admin Storage Actions`, `User Activity Timeline & Metric Cards`, `Community 54`, `Community 55`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `createAdminClient()` connect `Resend SMTP Email Integration & Signup Actions` to `Storage Service Providers & S3 Adapters`, `Organization Settings & Admin Storage Actions`, `Common UI Components & Utilities`?**
...
- **Should `System Architecture & Naming Guidelines` be split into smaller, more focused modules?**
